...
<section>
    ...
    <section id="services-left">
        <a href='/work'>
            <img className="services-image" src="/services1.jpeg" alt="House in Waimarama's living room" />
        </a>
    ...
    <section id="services-right">
        <a href='/work'>
            <img className="services-image" src="/services2.jpeg" alt="Commercial building exterior" />
        </a>
        <div className="services-text ">
    ...
    <section id="services-left">
        <a href='/work'>
            <img className="services-image" src="/services3.jpeg" alt="House in Waimarama's bathroom" />
        </a>
        <div className="services-text ">
    ...
    {/* Waterblasting */}
    <section id="services-right">
        <img className="services-image" src="/services4.jpeg" alt="Waterblasting exterior of house" />
        <div className="services-text ">
